...
def main(onnx_path, engine_path, max_batchsize, opt_batchsize, min_batchsize, use_fp16=True, verbose=False)->None:
    ...
    if min_batchsize != opt_batchsize or min_batchsize != max_batchsize:
    ...
    # Print shapes of all inputs/outputs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--maxBatchSize", "-Mb", type=int, default=1, help="Maximum batch size for inference")
    parser.add_argument("--optBatchSize", "-ob", type=int, default=1, help="Optimal batch size for inference")
