...
if __name__ == "__main__":
    ...
    parser.add_argument("--maxBatchSize", "-Mb", type=int, default=64, help="Maximum batch size for inference")
    parser.add_argument("--optBatchSize", "-ob", type=int, default=32, help="Optimal batch size for inference")
